...
class PairDataset(UnicoreDataset):
    ...
    def collater(self, samples):
        ...
        if len(samples) == 0:
            return {}
        for pocket, ligs, acts, uniprot, assay_id, prot_seq, seq_emb in samples:
        ...
        return {"pocket": ret_pocket, "lig": ret_lig, "protein": ret_protein,
                "batch_list": batch_list, "act_list": act_list, "sequence_emb": seq_emb_list,
    ...
    def __getitem__(self, idx):
        ...
        seq_emb = self.sequence_dataset[prot_seq]
        ...
        return pocket_data, lig_data, lig_act, uniprot, assay_id, prot_seq, seq_emb